    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="idExterno">
              <Translate contentKey="servidorApiApp.adicional.idExterno">Id Externo</Translate>
            </span>
          </dt>
          <dd>{adicionalEntity.idExterno}</dd>
          <dt>
            <span id="nombre">
          ...
          <dt>
            <Translate contentKey="servidorApiApp.adicional.venta">Venta</Translate>
          </dt>
          <dd>
