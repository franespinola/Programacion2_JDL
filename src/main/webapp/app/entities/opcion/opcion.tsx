              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="servidorApiApp.opcion.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
                  <th className="hand" onClick={sort('idExterno')}>
                    <Translate contentKey="servidorApiApp.opcion.idExterno">Id Externo</Translate>{' '}
