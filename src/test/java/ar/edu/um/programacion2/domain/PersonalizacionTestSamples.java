...
public class PersonalizacionTestSamples {
    ...
    public static Personalizacion getPersonalizacionSample1() {
        return new Personalizacion().id(1L).idExterno(1L).nombre("nombre1").descripcion("descripcion1");
    }

    public static Personalizacion getPersonalizacionSample2() {
        return new Personalizacion().id(2L).idExterno(2L).nombre("nombre2").descripcion("descripcion2");
    }
