...
public class CaracteristicaTestSamples {
    ...
    public static Caracteristica getCaracteristicaSample1() {
        return new Caracteristica().id(1L).idExterno(1L).nombre("nombre1").descripcion("descripcion1");
    }

    public static Caracteristica getCaracteristicaSample2() {
        return new Caracteristica().id(2L).idExterno(2L).nombre("nombre2").descripcion("descripcion2");
    }
