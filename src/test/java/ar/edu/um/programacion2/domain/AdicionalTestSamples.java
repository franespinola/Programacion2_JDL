...
public class AdicionalTestSamples {
    ...
    public static Adicional getAdicionalSample1() {
        return new Adicional().id(1L).idExterno(1L).nombre("nombre1").descripcion("descripcion1");
    }

    public static Adicional getAdicionalSample2() {
        return new Adicional().id(2L).idExterno(2L).nombre("nombre2").descripcion("descripcion2");
    }
